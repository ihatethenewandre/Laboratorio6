...
fun EventListScreen(navController: NavController,  modifier: Modifier = Modifier) {
    val favoriteEvents = listOf(
        Event("Alive 2007", "Palais Omnisports, París, Francia", "7 de julio, 07:00",
            "Este concierto es parte de la gira 'Alive 2007', donde Daft Punk presenta una mezcla de sus mayores éxitos.", R.drawable.ic_launcher_background),
        Event("Saint Pablo", "United Center, Chicago, EE.UU.", "22 de febrero, 22:00",
            "Kanye ofrece una experiencia inmersiva interpretando canciones de su álbum 'The Life of Pablo'.", R.drawable.ic_launcher_background),
        Event("Two Dollar Bill", "Hammerstein Ballroom, Nueva York, EE.UU.", "10 de octubre, 10:00",
            "The Strokes interpreta canciones de su álbum debut 'Is This It' para un público reducido.", R.drawable.ic_launcher_background),
        Event("The Black Parade Is Dead", "Madison Square Garden, Nueva York, EE.UU.", "5 de mayo, 05:00",
            "Un concierto teatral y emotivo, interpretando su icónico álbum 'The Black Parade'.", R.drawable.ic_launcher_background)
    )
    ...
    val allEvents = listOf(
        ...
        Event("Alive 1997", "Que Club, Birmingham, Inglaterra", "9 de noviembre, 19:00",
            "Grabado durante la gira 'Daftendirektour', capturando la energía cruda de Daft Punk en sus primeros años.", R.drawable.ic_launcher_background),
        Event("Glow In The Dark", "O2 Arena, Londres, Reino Unido", "4 de abril, 04:00",
            "Kanye presenta su álbum 'Graduation' con una producción escénica inspirada en una ópera espacial.", R.drawable.ic_launcher_background),
        Event("Saint Pablo", "United Center, Chicago, EE.UU.", "22 de febrero, 22:00",
            "Kanye ofrece una experiencia inmersiva interpretando canciones de su álbum 'The Life of Pablo'.", R.drawable.ic_launcher_background),
        Event("Two Dollar Bill", "Hammerstein Ballroom, Nueva York, EE.UU.", "10 de octubre, 10:00",
            "The Strokes interpreta canciones de su álbum debut 'Is This It' para un público reducido.", R.drawable.ic_launcher_background),
        ...
        Event("The Foundations Of Decay", "Shrine Expo Hall, Los Ángeles, EE.UU.", "20 de diciembre, 20:00",
            "El regreso de My Chemical Romance después de una pausa de seis años, emocionando a sus fans.", R.drawable.ic_launcher_background)
    )
    ...
    LazyColumn(modifier = modifier) {
        ...
        item {
            Text(text = "Your Favorites", fontSize = 24.sp, modifier = Modifier.padding(16.dp))
            EventGrid(events = favoriteEvents, navController)
        }
        item {
            Text(text = "All Concerts", fontSize = 24.sp, modifier = Modifier.padding(16.dp))
